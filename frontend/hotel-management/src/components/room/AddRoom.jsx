                ...
                <div className='row justify-content-center'>
                    <div className='col-md-8 col-lg-6'>
                        ...
                        <form onSubmit={handleSubmit}>
                            <div className='mb-3'>
                                <label htmlFor="roomType" className='form-lebel'>
                                    Room Type
                                </label>
                                <div>
                            ...
                            <div className='mb-3'>
                                <label htmlFor="roomPrice" className='form-lebel'>
                                    Room Price
                                </label>
                            ...
                            <div className='mb-3'>
                                <label htmlFor="photo" className='form-lebel'>
                                    Room Photo
                                </label>
                                <input id="photo" className='form-control' name="photo" type='file'
