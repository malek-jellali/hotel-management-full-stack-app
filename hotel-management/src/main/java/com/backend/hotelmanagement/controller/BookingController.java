...
import com.backend.hotelmanagement.service.BookingService;
...
public class BookingController {
    ...
    public ResponseEntity<?> getBookingByConfirmationCode(@PathVariable String confirmationCode){
        ...
        public ResponseEntity<?> saveBooking(@PathVariable Long roomId ,
            ...
            try {
                ...
                return ResponseEntity.ok("Room booked successfully ! youur booking confirmation code is : " + confirmationCode);
    ...
    private BookingResponse getBookingResponse(BookedRoom booking){
        ...
        return new BookingResponse(
                ...
                booking.getNbAdults(),
                booking.getNbChildren(),
                booking.getTotalNbGuests(),
