...
import com.backend.hotelmanagement.exceptions.PhotoRetrievalException;
...
import com.backend.hotelmanagement.service.BookingServiceImpl;
...
public ResponseEntity<RoomResponse> updateRoom(@PathVariable Long roomId ,
    ...
    return new RoomResponse(room.getId(), room.getType(), room.getPrice(), room.getIsBooked(), photoBytes ,  bookingInfo );
    }
